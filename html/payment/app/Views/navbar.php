  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/">
      ...
      <div>
        ...
        <div class="text-white-50"><small>Sistem Informasi Keuangan</small></div>
      </div>
    </a>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($page ?? '') === 'invoice' ? 'active' : '' ?>" href="/invoice/">Slip</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= ($page ?? '') === 'archive' ? 'active' : '' ?>" href="/archive/">Arsip</a>
        </li>
      </ul>
      <hr class="d-md-none">
    </div>
